// client/src/pages/GeofencesPage.jsx
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <div>
          <h1 className="text-2xl font-semibold">Bus stops</h1>
      ...
      {isLoading ? (
        ...
        <div className="glass rounded-2xl shadow-soft p-10 text-center text-gray-500 dark:text-gray-400">
          No stops yet. Add your first bus stop to start getting arrival notifications.
        </div>
      ) : (
        <div className="space-y-3">
          {geofences.map((fence) => (
